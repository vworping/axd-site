// Edit story text, photographs, and preview order here. Indices in preview.order start at 0.
window.PROJECTS = [
  {
    ...
    "images": [
      ...
      },
      {
        ...
        "alt": "A person riding a skateboard beside a colorful brick mural"
      },
      {
    ...
    "caseStudy": {
      ...
      "body": [
        ...
        "I was inside the creative process, adapting in real time to a live collaborative environment and helping shape how the story got told.",
      ...
      "facts": [
        {
          "label": "What I did",
          "value": "Process photography, on-site coordination, visual narrative"
        },
        {
          "label": "Collaborators",
          "value": "Abel Teclemariam, Converse, Institute of Contemporary Art"
        },
        {
          "label": "Outcome",
          "value": "Selected for Converse's All-Star creative community"
        }
      ]
    },
    "preview": {
  ...
  },
  {
    ...
    "cover": {
      "src": "assets/images/projects/ica city headshots/ica-city-01-cover.jpg",
      "width": 1200,
      "height": 1800,
      "aspect": 0.6667,
      "orientation": "portrait"
    ...
    "images": [
      {
        ...
        "aspect": 0.6667,
        "orientation": "portrait",
        "alt": "A smiling person poses with a large brown dog"
      },
      {
        "src": "assets/images/projects/ica city headshots/ica-city-02-image.jpg",
        "width": 1200,
        "height": 1800,
        "aspect": 0.6667,
        "orientation": "portrait"
      ...
      {
        "src": "assets/images/projects/ica city headshots/ica-city-03-image.jpg",
        "width": 1800,
        "height": 1200,
        "aspect": 1.5,
        "orientation": "landscape"
      ...
      {
        "src": "assets/images/projects/ica city headshots/ica-city-04-image.jpg",
        "width": 1200,
        "height": 1800,
        "aspect": 0.6667,
        "orientation": "portrait"
    ...
    "palette": [
      {
        ...
        "language": "worked midtone / skin warmth / amber cast"
      },
      {
        "rank": 2,
        "weight": 0.2921,
      ...
      },
      {
        ...
        "language": "low light / skin warmth / cream cast"
      }
    ],
    "poeticTag": "public service / soft confidence / future-facing light",
    "accent": "#734c36",
    "wash": "#b38d67",
    "caseStudy": {
      "title": "ICA x City of Boston Headshots",
      ...
      "links": [
        {
          "label": "View more portraits on Google Drive",
          "url": "https://drive.google.com/drive/folders/1luqL2aOkXu6qTk9IWoEJnFsTswF0gINZ?usp=sharing"
        }
      ],
      "body": [
      ...
      "facts": [
        {
          "label": "What I did",
          "value": "Headshot photography, participant flow, image export and delivery"
        },
        {
          "label": "Collaborators",
          "value": "ICA Teen Director Betsy Gibbons, ICA, City of Boston"
        },
        {
          "label": "Featured",
          "value": "Nurys S., Daphnee F., Elka G., Jasmine T. and friend"
        }
      ]
    },
    "preview": {
  ...
  },
  {
    ...
    "cover": {
      "src": "assets/images/projects/moia grad/moia-grad-01-cover.jpg",
      "width": 1800,
      "height": 1200,
      "aspect": 1.5,
      "orientation": "landscape"
    ...
    "images": [
      {
        ...
        "aspect": 1.5,
        "orientation": "landscape",
        "alt": "A smiling graduate holds a folder at the Immigrants Lead Boston ceremony"
      },
      {
        "src": "assets/images/projects/moia grad/moia-grad-02-image.jpg",
        "width": 1800,
        "height": 1200,
        "aspect": 1.5,
        "orientation": "landscape"
      ...
      {
        "src": "assets/images/projects/moia grad/moia-grad-03-image.jpg",
        "width": 1800,
        "height": 1200,
        "aspect": 1.5,
        "orientation": "landscape"
      ...
      {
        "src": "assets/images/projects/moia grad/moia-grad-04-image.jpg",
        "width": 1800,
        "height": 1200,
        "aspect": 1.5,
        "orientation": "landscape"
    ...
    "palette": [
      ...
      },
      {
        ...
        "language": "low light / neutral axis / blue cast"
      },
      {
        "rank": 3,
        "weight": 0.1842,
        ...
        "language": "worked midtone / skin warmth / quiet balance"
      },
      {
        "rank": 4,
        "weight": 0.1636,
    ...
    "poeticTag": "civic room / gathered pride / city light",
    "accent": "#dbd8dc",
    "wash": "#41445d",
    "caseStudy": {
      "title": "Immigrants Lead Boston Graduation",
      ...
      "facts": [
        {
          "label": "What I did",
          "value": "Ceremony photography, image sequencing, export coordination"
        },
        {
          "label": "Collaborators",
          "value": "City of Boston MOIA and Immigrants Lead Boston staff"
        },
        {
          "label": "Context",
          "value": "2022 ILB graduation for local immigrant community leaders"
        }
      ]
    },
    "preview": {
      "title": "Immigrants Lead Boston",
      "order": [
        0,
        1,
        2,
  ...
  },
  {
    ...
    "images": [
      {
        ...
        "aspect": 1.5,
        "orientation": "landscape",
        "alt": "A student styles a mannequin’s hair in a salon"
      },
      {
    ...
    "palette": [
      ...
      },
      {
        ...
        "language": "low light / skin warmth / blue cast"
      }
    ],
    ...
    "caseStudy": {
      ...
      "body": [
        ...
        "My role was to photograph the event while reading the room carefully, moving between process details, portraits, and the moments where students settled into being seen. What mattered was the exchange of care that made the day feel held.",
        "The final sequence emphasizes hands, mirrors, expressions, and the small gestures that turn a school event into a memory."
      ],
      "facts": [
        {
          "label": "What I did",
          "value": "Event photography, candid portraiture, image sequencing"
        },
        {
          "label": "Collaborators",
          "value": "Madison Park Vocational Technical High School students and graduating eighth graders"
        },
        {
          "label": "Focus",
          "value": "Graduation preparation through care, confidence, and community"
        }
      ]
    },
    "preview": {
